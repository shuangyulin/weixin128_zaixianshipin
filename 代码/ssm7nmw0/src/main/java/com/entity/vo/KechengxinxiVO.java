...
public class KechengxinxiVO  implements Serializable {
	...
	public void setKeshijiage(Integer keshijiage) {
		this.keshijiage = keshijiage;
	}
	
	/**
	 * 获取：课时价格
	 */
	public Integer getKeshijiage() {
		return keshijiage;
	}
	...
	public void setZhangjiemulu(String zhangjiemulu) {
		this.zhangjiemulu = zhangjiemulu;
	}
	
	/**
	 * 获取：章节目录
	 */
	public String getZhangjiemulu() {
		return zhangjiemulu;
	}
