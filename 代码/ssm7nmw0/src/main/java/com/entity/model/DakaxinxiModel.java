...
public class DakaxinxiModel  implements Serializable {
	...
	private Integer guankanfenzhong;
	...
	public void setGuankanfenzhong(Integer guankanfenzhong) {
		this.guankanfenzhong = guankanfenzhong;
	}
	
	/**
	 * 获取：观看分钟
	 */
	public Integer getGuankanfenzhong() {
		return guankanfenzhong;
	}
